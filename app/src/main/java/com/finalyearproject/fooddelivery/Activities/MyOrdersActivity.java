...
public class MyOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(String type, int position) {
                switch (type) {
                    case "Out for Delivery":
                        ...
                        startActivity(new Intent(MyOrdersActivity.this, MapsActivity.class));
                        break;
        ...
        foodRecyclerView.setLayoutManager(new LinearLayoutManager(MyOrdersActivity.this, LinearLayoutManager.VERTICAL, false));
        foodRecyclerView.setAdapter(foodAdapter);

        orders.child(firebaseAuth.getUid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                foods.clear();
                for (DataSnapshot dataSnapshot: snapshot.getChildren()) {
                    Food food = dataSnapshot.getValue(Food.class);
                    food.setCustomer(firebaseAuth.getUid());
